...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"browser-action.js":[function(require,module,exports) {
window.addEventListener("DOMContentLoaded", function () {
  var loginBtn = document.querySelector(".bt-login");
  var logoutBtn = document.querySelector(".bt-logout");
  var refreshBtn = document.querySelector(".bt-refresh");
  ...
  var refershRefactorings = function refershRefactorings() {
    ...
    chrome.tabs.getSelected(null, function (tab) {
      chrome.runtime.sendMessage({
        ...
        var value = data && data.refactorings && data.refactorings.length;
        refreshBtn.classList.remove("is-loading");
        messageBox.textContent = "".concat(value || 0, " refactorings found.");
        return true;
      });
    });
  };
